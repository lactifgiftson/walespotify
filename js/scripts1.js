...
function addItem() {
	...
	$.ajax({
		dataType : "json",
		url : "http://staging.weate.ch.stage18.535e.blackmesh.com/wbr/wale/middletier/wale/results.json",
...
function playPauseSong() {
	...
	if (!jQuery("#data-table-wrapper1 div.playlist").hasClass("active")) {
		...
		//CallOmniture('Anne-Marie:Friends Spotify Playlist Generator:Landing:Step 2:Play Song (player) Click');
	} else {
...
jQuery(document).ready(function() {
	...
	jQuery(".prev").on("click", function(e) {
		...
		//CallOmniture('Anne-Marie:Friends Spotify Playlist Generator:Landing:Step 2:Previous Song (player) Click');
		playPrevSong();
	});
	jQuery(".next").on("click", function(e) {
		...
		//CallOmniture('Anne-Marie:Friends Spotify Playlist Generator:Landing:Step 2:Next Song (player) Click');
		playNextSong();
	});
	jQuery(".playlist-button a").on("click", function() {
		jQuery(".ajax-loader").show();
		audioElement.pause();
		CallOmniture('Bryce Vine:Setlist Spotify Playlist Generator Email Signup:Landing:Step 2:Save Playlist Click');
